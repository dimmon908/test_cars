...
configatron.apn.port = 2195 # => 2195
configatron.apn.host = 'gateway.sandbox.push.apple.com' # => 'gateway.sandbox.push.apple.com'
configatron.apn.cert = File.join(Rails.root, 'config', 'test.pem') #=> File.join(Rails.root, 'config', 'apple_push_notification_development.pem')
